...
const peerReviewScore = 4.73;

// (DINAMIS) rata-rata Self Review (AI)
const selfReviewScore = reviews.reduce((acc, review) => acc + review.average, 0) / reviews.length;

// (GABUNGAN) rata-rata akhir
const finalAverage = (selfReviewScore + peerReviewScore) / 2;

// skala berdasarkan RATA-RATA AKHIR
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
            ...
            <div className="md:col-span-2 card-glass p-8 rounded-xl">
              <h3 className="text-3xl font-bold text-white mb-2">Rata-rata Gabungan</h3>
              ...
              <div className="space-y-2 mb-6">
                ...
                <div className="flex justify-between items-center text-lg p-3 bg-storm rounded-lg">
                  ...
                  <span className="font-bold text-white">{peerReviewScore.toFixed(2)} / 5.00</span>
                </div>
              </div>
              
              <h4 className="text-xl font-semibold text-white mb-2">Kesimpulan</h4>
              <p className="text-lg text-graphite-silver mb-8">
                "Secara keseluruhan, pencapaian ini menunjukkan... (tulis kesimpulanmu di sini)..."
              </p>
              
              <a 
                href="/files/UTS-5_Skor.xlsx" 
                download="Peer_Review_UTS_Rafif.xlsx" 
